...
$NAVIGATION_TEMPLATE['main']['start'] = '<div id="menu"><ul>';

// Main Link
$NAVIGATION_TEMPLATE['main']['item'] = '<li><a  href="{LINK_URL}"{LINK_OPEN} title="{LINK_DESCRIPTION}">{LINK_NAME}</a></li>';

// Main Link - active state
$NAVIGATION_TEMPLATE['main']['item_active'] = '<li><a id="menu_current" href="{LINK_URL}"{LINK_OPEN} title="{LINK_DESCRIPTION}">{LINK_NAME}</a></li>';
...
$NAVIGATION_TEMPLATE['main']['end'] = '</ul></div>';	
